...
void Quad::initFaces()
{
    vertices[0] = QVector4D(-0.5,0.0,-0.5,1.0);
    vertices[1] = QVector4D(-0.5,0.0, 0.5,1.0);
    vertices[2] = QVector4D( 0.5,0.0, 0.5,1.0);
    vertices[3] = QVector4D( 0.5,0.0,-0.5,1.0);
    normals[0] = QVector3D(0.0,1.0,0.0);
    normals[1] = QVector3D(0.0,1.0,0.0);
    normals[2] = QVector3D(0.0,1.0,0.0);
    normals[3] = QVector3D(0.0,1.0,0.0);
